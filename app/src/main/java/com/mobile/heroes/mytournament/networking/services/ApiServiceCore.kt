...
interface ApiServiceCore {
    ...
    fun postAccount(
        ...
        @Body favorite: AccountRequest
    ): Call<AccountResponce>
    ...
    fun getOneMatch(
        @Header("Authorization") token: String,
        @Path("id") id: String,
    ): Call<MatchRequestDTO>

    @PUT("${Constants.MATCH_URL}/{id}")
    fun updateMatch(
        @Header("Authorization") token: String,
        @Path("id") id: String,
        @Body match: MatchRequestDTO
    ): Call<MatchRequestDTO>
    ...
    fun getMatchesByTeamTournamentHome(
        @Header("Authorization") token: String,
        @Query("idTeamTournamentHomeId.equals") id: Int
    ): Call<List<MatchResponce>>

    @GET("${Constants.MATCH_BY}")
    fun getMatchesByTeamTournamentAway(
        @Header("Authorization") token: String,
        @Query("idTeamTournamentVisitorId.equals") id: Int
    ): Call<List<MatchResponce>>
    ...
    fun getMatchesByTournamentAndStatus(
        @Header("Authorization") token: String,
        @Body match: MetaMatchRequest
    ): Call<List<MetaMatchResponse>>
...
//    ): Call<TournamentResponse>
    ...
    fun deleteTeamTournament(
        @Header("Authorization") token: String,
        @Path("id") id: String
    ): Call<TeamTournamentResponse>

    @GET("${Constants.TEAM_TOURNAMENT_BY}")
    fun getTeamTournamentsByIdUser(
        @Header("Authorization") token: String,
        @Query("idUserId.equals") id: Int
    ): Call<List<TeamTournamentResponse>>

    @GET("${Constants.TEAM_TOURNAMENT_BY}")
    fun getTeamTournamentsById(
        @Header("Authorization") token: String,
        @Query("id.in") id: List<Int>
    ): Call<List<TeamTournamentResponse>>

    @GET("${Constants.TEAM_TOURNAMENT_BY}")
    fun getTeamTournamentsById(
        @Header("Authorization") token: String,
        @Query("id.equals") id: Int
    ): Call<List<TeamTournamentResponse>>
